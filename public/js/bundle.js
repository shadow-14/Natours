...
var stripe = Stripe('pk_test_51PzSDI02AfmbwOlLvIiUpoeK8RiGsKxWyDD1grEMPmzRWdtnl0Fzg735FXVCp4bKxxkX3ru0ZUETfEeijGc6J8eT00dRJFalMc');
...
var logoutBtne = document.querySelector('.nav__el--logout');
...
if (logoutBtne) {
  logoutBtne.addEventListener('click', _login.logout);
}
if (SignUpform) {
